...
class VideoDescriptionTrain(object):
    ...
    def preprocessing(self):
        ...
        self.tokenizer = Tokenizer(num_words=self.num_encoder_tokens)
    ...
    def load_dataset(self, training_list):
        ...
        file_size = train_sequences.shape[0]
        # print(file_size)
        n = 0
    ...
    def train_model(self):
        ...
        model.compile(metrics=['accuracy'], optimizer=opt, loss='categorical_crossentropy', run_eagerly=True)
        ...
        # Save the tokenizer
        tokenizer_path = os.path.join(self.save_model_path, 'tokenizer_' + str(self.num_decoder_tokens))
